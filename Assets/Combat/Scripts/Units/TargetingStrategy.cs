...
public class TargetingStrategy : MonoBehaviour
{
    ...
    public static bool CanPickVisibleHostile(Unit self, Unit candidate)
    {
        ...
        return IsTargetSelectable(self, candidate, policy);
    }
    ...
    #region Spacing & Nearest Hostile (from SpacingEvaluator)
    ...
    public static Unit GetSpacingThreat(Unit self, Unit currentTarget)
    {
        ...
        if (CanPickVisibleHostile(self, currentTarget))
            return currentTarget;
    ...
    public static Unit GetNearestVisibleHostile(Unit self)
    {
        ...
        return SelectClosestTarget(
            self,
            roomUnits,
            candidate => CanPickVisibleHostile(self, candidate));
    }

    #endregion

    #region Unit Target Validation (from UnitTargetValidator)
